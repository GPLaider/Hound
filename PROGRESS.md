...
- User-wide `C:\Users\Administrator\.agents\skills\hounds\SKILL.md` is byte-identical to the repository source and embedded installer text; frontmatter/name checks passed with no unfinished markers.
